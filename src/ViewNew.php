...
class View
{
    ...
    private static $scriptInjectingVariables = '<?php foreach (\Webrium\View::getParams() as $key => $value) {${$key}=$value;}; $_all = \Webrium\View::getParams(); ?>';
    ...
    {
        // return self::currentJsonFile()['list'][]
        // die($hashName);
    }
}
